      ...
      <div class="container" style="">
        <div class="row">
            ...
            >
              <sequential-entrance fromTop>
                <ul class="nav nav-tabs nav-justified" id="myTab">
                  <li
                    class="nav-item shadow-sm bg-white rounded"
                    style=""
                    @click="changeBurgerName"
                  >
                    <a
          ...
          <div class="col-xl-10 col-lg-9 col-sm-8 col-7 mb-5">
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  ...
                  <button class="chatbox-open" @click="cartPopup">
                    ...
                    <span
                      class="btn btn-danger rounded-circle align-center cart_count"
                      style="
                        font-size: 12px;
                        position: absolute;
                        width: 30px;
            ...
            <div
              style="border: none"
              class="animate__animated animate__fadeInBottomRight modal fade customize_modal"
              id="myModal2"
              tabindex="-1"
              role="dialog"
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header bg-warning">
                    <h6 class="modal-headings pt-2" id="exampleModalLongTitle">
                      Customize Your Food
                    </h6>
                  ...
                  <div class="modal-">
                    <div class="row mb-3">
                      ...
                      <div
                        class="col-md-7 my-auto col-5 input-box-customization"
                      >
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="align-middle pr-3">
                            <div
                              class="form-group my-auto d-flex justify-content-end"
                            >
                          ...
                          <td class="align-middle pr-3">
                            <div class="row">
                              <button class="btn btn-warning cart-sm-button">
                                -
                              </button>
                              <input
                                type="text"
                    ...
                    <div class="back-button-size">
                      ...
                      <router-link
                        to="/products"
                        id="btn"
                        class="cartbox-close btn btn-success confirm-button ml-4 confirm-button order-button-cart-size"
                        data-dismiss="modal"
              ...
              >
                <div class="card" style="">
                  <div class="card-header cart-header bg-warning">
                    <h6
                      class="float-left modal-headings ml-n2"
                      style="padding-top: 10px"
                    >
                      Items in Cart
                    </h6>
                    <button
                      class="btn btn-danger text-white float-right cartbox-close mr-n2"
                      style="padding-left: 40px; padding-right: 40px"
                    >
                      Close
                    </button>
                  </div>
                  <table class="table table-inverse table-responsive" v-if="cart.length > 0">
                    <tbody>
                      <tr v-for="(item, mid) in cart" key="item.id">
                        <td scope="row">
                  
                          <div class="card cart_image" :style="bgcss(item.image)"></div>
                        </td>
                        ...
                        <!-- <tr> -->
                        <td class="align-middle">
                          <button title="Delete" class="btn btn-danger" @click="cart.splice(mid,1)">
                            <i class="fa fa-trash-o" aria-hidden="true"></i>
                            Remove
                          </button>
                        </td>
                ...
                <div class="empty__cart" v-else>
                  ...
                  <div class="card-footer bg-white"  v-if="cart.length > 0">
                  ...
                  <div class="row">
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          class="card-footer border-0 bg-white items-name-price"
                        >
                          <h4>{{ item.name }}</h4>
