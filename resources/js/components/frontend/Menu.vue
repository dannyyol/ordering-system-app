          ...
          <div class="col-xl-10 col-lg-9 col-sm-8 col-8 mb-5">
            <div class="row">
              <div class="col-sm-12 col-md-7 col-lg-7 heading-products">
                ...
                <h3 v-if="show_dessert">{{ title_2  }}</h3>
              </div>
